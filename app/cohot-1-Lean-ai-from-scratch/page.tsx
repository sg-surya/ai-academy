...
export default function WorkshopLandingPage() {
  ...
  return (
    <div className="relative min-h-screen bg-[#FAF9F6] text-[#07130d] font-sans selection:bg-emerald-500/10 selection:text-[#0b3d2b] overflow-x-hidden">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-8 pt-16 sm:pt-20 pb-20">
                ...
                <div className="text-center py-8 space-y-4">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-slate-500 text-xs font-semibold max-w-xs mx-auto">
                      This workshop has concluded. Thank you for your interest!
                    </p>
                  </div>
        ...
        <section id="curriculum" className="py-16 border-t border-slate-200/60">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-5xl mx-auto">
            ...
            {/* Part 01 */}
            <div className="bg-white border-2 border-[#0b3d2b]/15 p-6 sm:p-7 shadow-[4px_4px_0px_#0b3d2b]/10">
              <div className="flex items-center justify-between text-[9px] font-mono font-bold text-slate-400 mb-4 uppercase tracking-wider">
                <span>Part 01</span>
                <span className="bg-emerald-500/10 text-[#0b3d2b] px-2 py-0.5 border border-[#0b3d2b]/10 font-black">AI Basics</span>
              </div>
              <div className="flex items-center space-x-3 mb-4">
                <div className="w-10 h-10 bg-slate-50 border border-slate-200 text-[#0b3d2b] flex items-center justify-center shrink-0 font-mono font-black text-sm">01</div>
                <div>
                  <h3 className="font-mono text-[10px] text-slate-400 font-extrabold tracking-widest uppercase">SECTION GOAL</h3>
                  <p className="text-emerald-950 text-xs font-extrabold uppercase">Eliminate Tech Fear</p>
                </div>
              </div>
              <ul className="space-y-3 font-sans text-xs text-slate-600 border-t border-slate-100 pt-4">
                <li className="flex items-start space-x-2"><span className="text-emerald-600 mt-0.5 font-bold shrink-0">✦</span><span className="font-semibold text-slate-700">What is AI? (Simple approach)</span></li>
                <li className="flex items-start space-x-2"><span className="text-emerald-600 mt-0.5 font-bold shrink-0">✦</span><span className="font-semibold text-slate-700">What is Machine Learning?</span></li>
                <li className="flex items-start space-x-2"><span className="text-emerald-600 mt-0.5 font-bold shrink-0">✦</span><span className="font-semibold text-slate-700">What are LLMs? (Beginner friendly)</span></li>
                <li className="flex items-start space-x-2"><span className="text-emerald-600 mt-0.5 font-bold shrink-0">✦</span><span className="font-semibold text-slate-700">How does ChatGPT work?</span></li>
                <li className="flex items-start space-x-2"><span className="text-emerald-600 mt-0.5 font-bold shrink-0">✦</span><span className="font-semibold text-slate-700">The Future &amp; Opportunities</span></li>
              </ul>
            </div>
            ...
            <div className="bg-white border-2 border-[#0b3d2b]/15 p-6 sm:p-7 shadow-[4px_4px_0px_#0b3d2b]/10">
              ...
              <div className="flex items-center space-x-3 mb-4">
                <div className="w-10 h-10 bg-slate-50 border border-slate-200 text-[#0b3d2b] flex items-center justify-center shrink-0 font-mono font-black text-sm">02</div>
                <div>
                  <h3 className="font-mono text-[10px] text-slate-400 font-extrabold tracking-widest uppercase">SECTION GOAL</h3>
              ...
              <ul className="space-y-3 font-sans text-xs text-slate-600 border-t border-slate-100 pt-4">
                <li className="flex items-start space-x-2"><span className="text-emerald-600 mt-0.5 font-bold shrink-0">✦</span><span className="font-semibold text-slate-700">ChatGPT &amp; Claude Prompting</span></li>
                <li className="flex items-start space-x-2"><span className="text-emerald-600 mt-0.5 font-bold shrink-0">✦</span><span className="font-semibold text-slate-700">Gemini &amp; Workspace Tools</span></li>
                <li className="flex items-start space-x-2"><span className="text-emerald-600 mt-0.5 font-bold shrink-0">✦</span><span className="font-semibold text-slate-700">AI Image Tools (Midjourney, etc)</span></li>
                <li className="flex items-start space-x-2"><span className="text-emerald-600 mt-0.5 font-bold shrink-0">✦</span><span className="font-semibold text-slate-700">No-Code AI App Builders</span></li>
                <li className="flex items-start space-x-2"><span className="text-emerald-600 mt-0.5 font-bold shrink-0">✦</span><span className="font-semibold text-slate-700">Practical AI Coding Creators</span></li>
              </ul>
            </div>
            ...
            <div className="bg-white border-2 border-[#0b3d2b]/15 p-6 sm:p-7 shadow-[4px_4px_0px_#0b3d2b]/10">
              ...
              <div className="flex items-center space-x-3 mb-4">
                <div className="w-10 h-10 bg-slate-50 border border-slate-200 text-[#0b3d2b] flex items-center justify-center shrink-0 font-mono font-black text-sm">03</div>
                <div>
                  <h3 className="font-mono text-[10px] text-slate-400 font-extrabold tracking-widest uppercase">SECTION GOAL</h3>
              ...
              <ul className="space-y-3 font-sans text-xs text-slate-600 border-t border-slate-100 pt-4">
                <li className="flex items-start space-x-2"><span className="text-amber-600 mt-0.5 font-bold shrink-0">✦</span><span className="font-bold text-slate-800">Build Live AI Chatbot</span></li>
                <li className="flex items-start space-x-2"><span className="text-amber-600 mt-0.5 font-bold shrink-0">✦</span><span className="font-bold text-slate-800">Generate fully customized Webpage</span></li>
                <li className="flex items-start space-x-2"><span className="text-amber-600 mt-0.5 font-bold shrink-0">✦</span><span className="font-bold text-slate-800">Create smart automated actions</span></li>
                <li className="flex items-start space-x-2"><span className="text-amber-600 mt-0.5 font-bold shrink-0">✦</span><span className="font-bold text-slate-800">Run Offline AI systems locally</span></li>
              </ul>
            </div>
            ...
            <div className="bg-white border-2 border-[#0b3d2b]/15 p-6 sm:p-7 shadow-[4px_4px_0px_#0b3d2b]/10">
              ...
              <div className="flex items-center space-x-3 mb-4">
                <div className="w-10 h-10 bg-slate-50 border border-slate-200 text-[#0b3d2b] flex items-center justify-center shrink-0 font-mono font-black text-sm">04</div>
                <div>
                  <h3 className="font-mono text-[10px] text-slate-400 font-extrabold tracking-widest uppercase">SECTION GOAL</h3>
              ...
              <ul className="space-y-3 font-sans text-xs text-slate-600 border-t border-slate-100 pt-4">
                <li className="flex items-start space-x-2"><span className="text-emerald-600 mt-0.5 font-bold shrink-0">✦</span><span className="font-semibold text-slate-700">AI Careers &amp; Job Opportunities</span></li>
                <li className="flex items-start space-x-2"><span className="text-emerald-600 mt-0.5 font-bold shrink-0">✦</span><span className="font-semibold text-slate-700">Detailed AI Skills Roadmap</span></li>
                <li className="flex items-start space-x-2"><span className="text-emerald-600 mt-0.5 font-bold shrink-0">✦</span><span className="font-semibold text-slate-700">Curated resource templates</span></li>
                <li className="flex items-start space-x-2"><span className="text-emerald-600 mt-0.5 font-bold shrink-0">✦</span><span className="font-semibold text-slate-700">How to keep learning easily</span></li>
              </ul>
            </div>
        ...
        <section id="registration-section" className="py-12">
          ...
          >
            ...
            <a 
              href="/cohot-1-Lean-ai-from-scratch#hero" 
          ...
          <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center justify-center gap-4 w-full md:w-auto">
              ...
              <button
                ...
                className="bg-amber-500 hover:bg-amber-400 text-slate-950 font-mono text-[10.5px] uppercase tracking-wider font-extrabold py-2.5 px-5 border border-slate-950 shadow-[2px_2px_0px_#ffffff] hover:shadow-[1px_1px_0px_#ffffff] transition-all duration-150 text-center shrink-0 cursor-pointer"
              >
      ...
      {/* BANNER MODAL - WORKSHOP COMPLETED */}
      <AnimatePresence>
        {showBannerModal && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
            ...
            <motion.div
              ...
              className="relative w-full max-w-sm bg-white border-4 border-[#0b3d2b] p-6 sm:p-8 text-[#07130d] shadow-[8px_8px_0px_#07130d] z-10 overflow-hidden"
              onClick={(e) => e.stopPropagation()}
            >
              <div className="absolute top-0 left-0 right-0 h-2 bg-emerald-500" />
              <button
                onClick={() => setShowBannerModal(false)}
                className="absolute top-4 right-4 text-slate-400 hover:text-[#0b3d2b] transition-colors p-1 border border-transparent hover:border-slate-200 cursor-pointer"
              ...
              <div className="text-center space-y-5 pt-4">
                ...
                <div className="space-y-1">
                  ...
                  <h3 className="font-display text-2xl font-black text-[#07130d] tracking-tight leading-tight mt-3">
                    Workshop Completed
                  </h3>
                  <p className="text-slate-500 text-xs font-semibold leading-relaxed max-w-xs mx-auto">
                    This workshop has concluded. Thank you for your participation!
                  </p>
                </div>
                ...
                <button
                  onClick={() => setShowBannerModal(false)}
                  className="bg-[#0b3d2b] hover:bg-[#0a3525] text-white font-mono text-xs font-black uppercase tracking-wider px-6 py-3 border-2 border-[#07130d] shadow-[3px_3px_0px_#07130d] hover:translate-x-[1px] hover:translate-y-[1px] hover:shadow-[2px_2px_0px_#07130d] active:translate-x-[3px] active:translate-y-[3px] active:shadow-none transition-all duration-150 w-full"
                >
                  Got it
                </button>
              </div>
